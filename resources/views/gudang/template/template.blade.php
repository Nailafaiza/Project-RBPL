        ...
        <div class="sidebar-top">
            ...
            <div class="menu">
                <a href="/gudang/dashboard" 
                   class="{{ request()->is('gudang/dashboard') ? 'active' : '' }}">
                   Dashboard
                </a>
            
                <a href="/gudang/lap_penerimaan" 
                   class="{{ request()->is('gudang/lap_penerimaan') ? 'active' : '' }}">
                   Laporan Penerimaan
                </a>
            
                <a href="/gudang/lap_stok" 
                   class="{{ request()->is('gudang/lap_stok') ? 'active' : '' }}">
                   Laporan Stok
                </a>
            </div>
        </div>
