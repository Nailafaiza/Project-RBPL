        ...
        <form action="{{ route('penjualan.store') }}" method="POST">
            ...
            <div class="row-flex">
                <div class="input-group">
                    ...
                    <input type="number" name="jumlah_terjual" class="input" value="{{ old('jumlah_terjual', 0) }}">
                </div>

            <div class="row-flex">
                <div class="input-group">
                    <div class="label">Harga Satuan</div>
                    <input type="number" name="harga_satuan" class="input" value="{{ old('harga_satuan', 0) }}">
                </div>
        
                <div class="input-group">
                    <div class="label">Total</div>
                    <input type="number" name="total" class="input" value="{{ old('total')}}">
                </div>
            </div>
