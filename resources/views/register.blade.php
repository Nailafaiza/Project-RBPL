...
<div class="role-container" id="roleSelection">
    <div class="role-card" onclick="showRegister('manajer_gudang', 'Manajer Gudang')">
        <i class="bi bi-box-seam" style="font-size: 50px;"></i>
        <h3>Manajer<br>Gudang</h3>
    </div>

    <div class="role-card" onclick="showRegister('admin_toko', 'Admin Toko')">
        <i class="bi bi-shop" style="font-size: 50px;"></i>
        <h3>Admin<br>Toko</h3>
    </div>

    <div class="role-card" onclick="showRegister('manajer_pusat', 'Manajer Pusat')">
...
<p style="margin-top:15px; text-align:center;">
    Sudah punya akun?
    <a href="{{ route('login') }}" style="color:#a63a56; font-weight:600;">
        Login
    </a>
</p>

<script>
function showRegister(roleValue, roleLabel) {
    document.getElementById("roleSelection").style.display = "none";
    document.getElementById("registerForm").style.display = "block";

    document.getElementById("roleTitle").innerText = "Register sebagai " + roleLabel;
...
<div class="popup-overlay" id="popupOverlay">
    <div class="popup-box">
        ...
        <button type="button" class="popup-button" onclick="closePopup()">Kembali</button>
    </div>
</div>
@endif
